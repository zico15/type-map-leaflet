...
var jo = (dt, $, u) => $ in dt ? qo(dt, $, { enumerable: !0, configurable: !0, writable: !0, value: u }) : dt[$] = u;
var vn = (dt, $, u) => (jo(dt, typeof $ != "symbol" ? $ + "" : $, u), u);
import { Component as Ko } from "typecomposer";
var Yo = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Je = { exports: {} };
/* @preserve
...
(function(dt, $) {
  (function(u, G) {
    ...
    var Vt = Object.create || /* @__PURE__ */ function() {
      function t() {
      }
      return function(e) {
    ...
    ot.extend = function(t) {
      ...
      return t.statics && x(e, t.statics), t.includes && (wn(t.includes), x.apply(null, [n].concat(t.includes))), x(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? Vt(i.options) : {}, x(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
    ...
    var ye = document.documentElement.style, jt = "ActiveXObject" in window, Pn = jt && !document.addEventListener, ui = "msLaunchUri" in navigator && !("documentMode" in document), we = tt("webkit"), li = tt("android"), ci = tt("android 2") || tt("android 3"), Ln = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), Tn = li && tt("Google") && Ln < 537 && !("AudioNode" in window), xe = !!window.opera, fi = !ui && tt("chrome"), di = tt("gecko") && !we && !xe && !jt, bn = !fi && tt("safari"), _i = tt("phantom"), mi = "OTransition" in ye, Mn = navigator.platform.indexOf("Win") === 0, pi = jt && "transition" in ye, Pe = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !ci, vi = "MozPerspective" in ye, Cn = !window.L_DISABLE_3D && (pi || Pe || vi) && !mi && !_i, Zt = typeof orientation < "u" || tt("mobile"), Sn = Zt && we, zn = Zt && Pe, gi = !window.PointerEvent && window.MSPointerEvent, yi = !!(window.PointerEvent || gi), wi = "ontouchstart" in window || !!window.TouchEvent, kn = !window.L_NO_TOUCH && (wi || yi), En = Zt && xe, Zn = Zt && di, On = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, In = function() {
      var t = !1;
      try {
    ...
    if ("onselectstart" in document)
      ...
      At = function() {
        ...
        Nt && (document.documentElement.style[Nt] = Se, Se = void 0);
      };
    }
    function ze() {
    ...
    function Ae(t, e, i, n) {
      ...
      !f.touchNative && f.pointer && e.indexOf("touch") === 0 ? s = Hn(t, e, s) : f.touch && e === "dblclick" ? s = Kn(t, s) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(Ie[e] || e, s, f.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (s = function(a) {
        a = a || window.event, Re(t, a) && r(a);
      }, t.addEventListener(Ie[e], s, !1)) : t.addEventListener(e, r, !1) : t.attachEvent("on" + e, s), t[et] = t[et] || {}, t[et][o] = s;
    }
    function Be(t, e, i, n, o) {
      ...
      if (!s)
        return this;
      !f.touchNative && f.pointer && e.indexOf("touch") === 0 ? Fn(t, e, s) : f.touch && e === "dblclick" ? Yn(t, s) : "removeEventListener" in t ? t.removeEventListener(Ie[e] || e, s, !1) : t.detachEvent("on" + e, s), t[et][o] = null;
    }
    function vt(t) {
    ...
    var Qn = {
      ...
      flyTo: function(t, e, i) {
        ...
        var a = Math.max(s.x, s.y), h = a * this.getZoomScale(r, e), l = o.distanceTo(n) || 1, c = 1.42, d = c * c;
        function g(A) {
          var ce = A ? -1 : 1, Wo = A ? h : a, Uo = h * h - a * a + ce * d * d * l * l, Go = 2 * Wo * d * l, Ye = Uo / Go, pn = Math.sqrt(Ye * Ye + 1) - Ye, Vo = pn < 1e-9 ? -18 : Math.log(pn);
          return Vo;
        }
        function R(A) {
        ...
        function Ro(A) {
          return a * (B(W) * K(W + c * A) - R(W)) / d;
        }
        function Do(A) {
          return 1 - Math.pow(1 - A, 1.5);
        }
        var Ho = Date.now(), _n = (g(1) - W) / c, Fo = i.duration ? 1e3 * i.duration : 1e3 * _n * 0.8;
        function mn() {
          var A = (Date.now() - Ho) / Fo, ce = Do(A) * _n;
          A <= 1 ? (this._flyToFrame = D(mn, this), this._move(
            this.unproject(n.add(o.subtract(n).multiplyBy(Ro(ce) / l)), r),
      ...
      getBoundsZoom: function(t, e, i) {
        t = O(t), i = _(i || [0, 0]);
        var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(), a = t.getSouthEast(), h = this.getSize().subtract(i), l = H(this.project(a, n), this.project(r, n)).getSize(), c = f.any3d ? this.options.zoomSnap : 1, d = h.x / l.x, g = h.y / l.y, R = e ? Math.max(d, g) : Math.min(d, g);
    ...
    var io = function(t) {
      ...
      return new Ni(t);
    }, oo = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', He = X.extend({
      // @section
    ...
    X.Layers = Bi, X.Zoom = De, X.Scale = Ni, X.Attribution = He, Dt.layers = eo, Dt.zoom = io, Dt.scale = no, Dt.attribution = so;
    var it = ot.extend({
      initialize: function(t) {
        this._map = t;
      },
    ...
    var ro = { Events: U }, Ri = f.touch ? "touchstart mousedown" : "mousedown", ct = kt.extend({
      options: {
        // @section
      ...
      disable: function() {
        this._enabled && (ct._dragging === this && this.finishDrag(!0), M(this._dragStartTarget, Ri, this._onDown, this), this._enabled = !1, this._moved = !1);
      },
      _onDown: function(t) {
        if (this._enabled && (this._moved = !1, !Me(this._element, "leaflet-zoom-anim"))) {
          ...
          if (!(ct._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (ct._dragging = this, this._preventOutline && Ze(this._element), ze(), At(), !this._moving)) {
            this.fire("down");
    ...
    function Di(t, e, i) {
      var n, o = [1, 4, 2, 8], s, r, a, h, l, c, d, g;
      for (s = 0, c = t.length; s < c; s++)
        t[s]._code = yt(t[s], e);
      for (a = 0; a < 4; a++) {
        for (d = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
          h = t[s], l = t[r], h._code & d ? l._code & d || (g = te(l, h, d, e, i), g._code = yt(g, e), n.push(g)) : (l._code & d && (g = te(l, h, d, e, i), g._code = yt(g, e), n.push(g)), n.push(h));
        t = n;
      }
      return t;
    }
    function Hi(t, e) {
      ...
      for (i = 0; i < B; i++) {
        var W = y(t[i]);
        K.push(e.project(y([W.lat - d.lat, W.lng - d.lng])));
      }
      for (a = h = l = 0, i = 0, n = B - 1; i < B; n = i++)
        o = K[i], s = K[n], r = o.y * s.x - s.y * o.x, h += (o.x + s.x) * r, l += (o.y + s.y) * r, a += r * 3;
      a === 0 ? c = K[0] : c = [h / a, l / a];
    ...
    function Gi(t, e, i, n, o) {
      var s = n ? Ui : yt(t, i), r = yt(e, i), a, h, l;
      for (Ui = r; ; ) {
        if (!(s | r))
          return [t, e];
        if (s & r)
          return !1;
        a = s || r, h = te(t, e, a, i, o), l = yt(h, i), a === s ? (t = h, s = l) : (e = h, r = l);
      }
    }
    function te(t, e, i, n, o) {
      var s = e.x - t.x, r = e.y - t.y, a = n.min, h = n.max, l, c;
      return i & 8 ? (l = t.x + s * (h.y - t.y) / r, c = h.y) : i & 4 ? (l = t.x + s * (a.y - t.y) / r, c = a.y) : i & 2 ? (l = h.x, c = t.y + r * (h.x - t.x) / s) : i & 1 && (l = a.x, c = t.y + r * (a.x - t.x) / s), new m(l, c, o);
    }
    function yt(t, e) {
      var i = 0;
    ...
    function Ht(t, e, i, n) {
      ...
      return h > 0 && (l = ((t.x - o) * r + (t.y - s) * a) / h, l > 1 ? (o = i.x, s = i.y) : l > 0 && (o += r * l, s += a * l)), r = t.x - o, a = t.y - s, n ? r * r + a * a : new m(o, s);
    }
    function j(t) {
    ...
    function qi(t, e) {
      ...
      for (i = 0; i < R; i++) {
        var K = y(t[i]);
        B.push(e.project(y([K.lat - c.lat, K.lng - c.lng])));
      }
      for (i = 0, n = 0; i < R - 1; i++)
    ...
    st.Earth = lt, st.EPSG3395 = mo, st.EPSG3857 = ge, st.EPSG900913 = xn, st.EPSG4326 = ji, st.Simple = po;
    var J = kt.extend({
    ...
    var Ft = Tt.extend({
      ...
      _getIconUrl: function(t) {
        return typeof Ft.imagePath != "string" && (Ft.imagePath = this._detectIconPath()), (this.options.imagePath || Ft.imagePath) + Tt.prototype._getIconUrl.call(this, t);
      },
      ...
      _adjustPan: function(t) {
        ...
        if (!h.contains(s)) {
          ...
          i.panBy(l, { animate: !1 }), this._draggable._newPos._add(l), this._draggable._startPos._add(l), I(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = D(this._adjustPan.bind(this, t));
        }
      },
      ...
      _initInteraction: function() {
        if (this.options.interactive && (v(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), Ki)) {
    ...
    var Ve = ie.extend({
      initialize: function(t, e, i) {
        if (typeof e == "number" && (e = x({}, i, { radius: e })), S(this, e), this._latlng = y(t), isNaN(this.options.radius))
      ...
      _project: function() {
        ...
        if (n.distance === lt.distance) {
          var o = Math.PI / 180, s = this._mRadius / lt.R / o, r = i.project([e + s, t]), a = i.project([e - s, t]), h = r.add(a).divideBy(2), l = i.unproject(h).lat, c = Math.acos((Math.cos(s * o) - Math.sin(e * o) * Math.sin(l * o)) / (Math.cos(e * o) * Math.cos(l * o))) / o;
    ...
    var bt = at.extend({
      ...
      _setLatLngs: function(t) {
        at.prototype._setLatLngs.call(this, t), j(this._latlngs) && (this._latlngs = [this._latlngs]);
      },
      _defaultShape: function() {
    ...
    function ne(t, e) {
      var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, o = [], s = e && e.pointToLayer, r = e && e.coordsToLatLng || qe, a, h, l, c;
      if (!n && !i)
        return null;
      switch (i.type) {
        case "Point":
    ...
    var he = nt.extend({
      ...
      onAdd: function(t) {
        nt.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof ft || this._source.on("preclick", vt));
      },
      onRemove: function(t) {
        nt.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof ft || this._source.off("preclick", vt));
      },
      getEvents: function() {
      ...
      _adjustPan: function() {
        if (this.options.autoPan) {
          ...
          var s = t.layerPointToContainerPoint(o), r = _(this.options.autoPanPadding), a = _(this.options.autoPanPaddingTopLeft || r), h = _(this.options.autoPanPaddingBottomRight || r), l = t.getSize(), c = 0, d = 0;
          s.x + n + h.x > l.x && (c = s.x + n - l.x + h.x), s.x - c - a.x < 0 && (c = s.x - a.x), s.y + i + h.y > l.y && (d = s.y + i - l.y + h.y), s.y - d - a.y < 0 && (d = s.y - a.y), (c || d) && (this.options.keepInView && (this._autopanning = !0), t.fire("autopanstart").panBy([c, d]));
        }
      },
      _getAnchor: function() {
    ...
    var ue = nt.extend({
      ...
      _setPosition: function(t) {
        var e, i, n = this._map, o = this._container, s = n.latLngToContainerPoint(n.getCenter()), r = n.layerPointToContainerPoint(t), a = this.options.direction, h = o.offsetWidth, l = o.offsetHeight, c = _(this.options.offset), d = this._getAnchor();
        a === "top" ? (e = h / 2, i = l) : a === "bottom" ? (e = h / 2, i = 0) : a === "center" ? (e = h / 2, i = l / 2) : a === "right" ? (e = 0, i = l / 2) : a === "left" ? (e = h, i = l / 2) : r.x < s.x ? (a = "right", e = 0, i = l / 2) : (a = "left", e = h + (c.x + d.x) * 2, i = l / 2), t = t.subtract(_(e, i, !0)).add(c).add(d), Z(o, "leaflet-tooltip-right"), Z(o, "leaflet-tooltip-left"), Z(o, "leaflet-tooltip-top"), Z(o, "leaflet-tooltip-bottom"), v(o, "leaflet-tooltip-" + a), I(o, t);
      },
      _updatePosition: function() {
    ...
    var Wt = J.extend({
        ...
        if (e) {
          ...
          if (t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0) {
            ...
            for (var l in this._tiles) {
              ...
              (c.z !== this._tileZoom || !h.contains(new m(c.x, c.y))) && (this._tiles[l].current = !1);
            }
      ...
      _tileReady: function(t, e, i) {
        ...
        i = this._tiles[n], i && (i.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (q(i.el, 0), V(this._fadeFrame), this._fadeFrame = D(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (v(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
          tile: i.el,
          coords: t
    ...
    var Ct = Wt.extend({
      ...
      getTileUrl: function(t) {
        ...
        return ei(this._url, x(e, this.options));
      },
      ...
      _removeTile: function(t) {
        var e = this._tiles[t];
        if (e)
          return e.el.setAttribute("src", qt), Wt.prototype._removeTile.call(this, t);
      },
      _tileReady: function(t, e, i) {
    ...
    var en = Ct.extend({
      ...
      getTileUrl: function(t) {
        var e = this._tileCoordsToNwSe(t), i = this._crs, n = H(i.project(e[0]), i.project(e[1])), o = n.min, s = n.max, r = (this._wmsVersion >= 1.3 && this._crs === ji ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","), a = Ct.prototype.getTileUrl.call(this, t);
    ...
    var ut = J.extend({
      ...
      initialize: function(t) {
        S(this, t), P(this), this._layers = this._layers || {};
      },
      onAdd: function() {
    ...
    Gt.create = le, Gt.pointsToPath = hi, ht.geometryToLayer = ne, ht.coordsToLatLng = qe, ht.coordsToLatLngs = oe, ht.latLngToCoords = je, ht.latLngsToCoords = se, ht.getFeature = Mt, ht.asFeature = re, w.mergeOptions({
    ...
    var un = it.extend({
      ...
      _onDragEnd: function(t) {
        ...
        if (e.fire("dragend", t), n)
          ...
          var o = this._lastPos.subtract(this._positions[0]), s = (this._lastTime - this._times[0]) / 1e3, r = i.easeLinearity, a = o.multiplyBy(r / s), h = a.distanceTo([0, 0]), l = Math.min(i.inertiaMaxSpeed, h), c = a.multiplyBy(l / h), d = l / (i.inertiaDeceleration * r), g = c.multiplyBy(-d / 2).round();
    ...
    var cn = it.extend({
      ...
      _onWheelScroll: function(t) {
        ...
        clearTimeout(this._timer), this._timer = setTimeout(C(this._performZoom, this), n), gt(t);
      },
    ...
    w.addInitHook("addHandler", "touchZoom", dn), w.BoxZoom = an, w.DoubleClickZoom = hn, w.Drag = un, w.Keyboard = ln, w.ScrollWheelZoom = cn, w.TapHold = fn, w.TouchZoom = dn, u.Bounds = z, u.Browser = f, u.CRS = st, u.Canvas = nn, u.Circle = Ve, u.CircleMarker = ie, u.Class = ot, u.Control = X, u.DivIcon = Qi, u.DivOverlay = nt, u.DomEvent = Qn, u.DomUtil = Jn, u.Draggable = ct, u.Evented = kt, u.FeatureGroup = rt, u.GeoJSON = ht, u.GridLayer = Wt, u.Handler = it, u.Icon = Tt, u.ImageOverlay = ae, u.LatLng = b, u.LatLngBounds = F, u.Layer = J, u.LayerGroup = Lt, u.LineUtil = fo, u.Map = w, u.Marker = ee, u.Mixin = ro, u.Path = ft, u.Point = m, u.PolyUtil = ao, u.Polygon = bt, u.Polyline = at, u.Popup = he, u.PosAnimation = Ai, u.Projection = _o, u.Rectangle = rn, u.Renderer = ut, u.SVG = Gt, u.SVGOverlay = $i, u.TileLayer = Ct, u.Tooltip = ue, u.Transformation = ve, u.Util = yn, u.VideoOverlay = Ji, u.bind = C, u.bounds = H, u.canvas = on, u.circle = Po, u.circleMarker = xo, u.control = Dt, u.divIcon = Eo, u.extend = x, u.featureGroup = go, u.geoJSON = Xi, u.geoJson = bo, u.gridLayer = Zo, u.icon = yo, u.imageOverlay = Mo, u.latLng = y, u.latLngBounds = O, u.layerGroup = vo, u.map = to, u.marker = wo, u.point = _, u.polygon = To, u.polyline = Lo, u.popup = zo, u.rectangle = Ao, u.setOptions = S, u.stamp = P, u.svg = sn, u.svgOverlay = So, u.tileLayer = tn, u.tooltip = ko, u.transformation = Et, u.version = G, u.videoOverlay = Co;
    var No = window.L;
...
class Xo extends Ko {
  constructor(u) {
    super({ id: "map", height: "500px", width: "500px", ...u });
    vn(this, "_map");
    this._map = Xe.map(this, u), u.center = u.center || [51.505, -0.09], Object.defineProperty(this, "load", {
      value: () => {
        this.loadMap.bind(this, u.key, u.center || [51.505, -0.09])();
      }
    }), document.addEventListener("DOMContentLoaded", this.load.bind(this)), this.onInit();
  }
  load() {
  }
  loadMap(u, G) {
    console.log("loadMap", u, G), this._map.setView(G, 13), Xe.tileLayer(`https://api.maptiler.com/maps/streets-v2/{z}/{x}/{y}.png?key=${u}`, {
      attribution: '<a href="https://www.maptiler.com/copyright/" target="_blank">&copy; MapTiler</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
      crossOrigin: !0
    }).addTo(this.map), document.removeEventListener("DOMContentLoaded", this.loadMap.bind(this, u, G));
  }
  addMarker(u, G) {
    const x = Xe.marker(G).addTo(this.map);
    return x.bindPopup(u).openPopup(), x;
  }
  get center() {
  ...
  disconnectedCallback() {
    var u, G, x;
    (u = this.unmount) == null || u.call(this), (G = this._styleRef) == null || G.disconnectedCallback(), (x = this.removeEvents) == null || x.call(this);
  }
}
customElements.define("map-leaflet", Xo, void 0);
export {
  Xo as MapLeaflet
};
