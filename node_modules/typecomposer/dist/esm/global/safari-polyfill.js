if (/^((?!chrome|android).)*safari/i.test(navigator.userAgent)) {
    const { keys: e } = Object, t = !0, r = !1, n = "querySelectorAll", o = "querySelectorAll", { document: l, Element: s, MutationObserver: a, Set: c, WeakMap: u } = self, 
    /// @ts-ignore
    i = (e) => o in e, { filter: d } = [];
    /// @ts-ignore
    var h = (e) => {
        ...
        g = (e, t = !0) => {
            for (let r = 0, { length: n } = e; r < n; r++)
                f(e[r], t);
        }, { query: p } = e, b = e.root || l, y = ((e, o = document, l = MutationObserver, s = ["*"]) => {
            /// @ts-ignore
            const a = (r, o, l, s, c, u) => {
                for (const i of r)
                ...
                if (s.length) {
                    const n = s.join(","), o = new Set(), l = new Set();
        ...
        })(f, b, a, p), { attachShadow: w } = s.prototype;
        return (w &&
            ...
            p.length && g(b[o](p)),
            {
                ...
                flush: () => {
                    ...
                    for (let t = 0, { length: r } = e; t < r; t++)
                        g(d.call(e[t].removedNodes, i), !1), g(d.call(e[t].addedNodes, i), !0);
                },
                observer: y,
                parse: g,
            });
    ...
    }, { defineProperty: N, getOwnPropertyNames: $, setPrototypeOf: P } = y, C = new v(), j = new S(), V = new m(), L = new m(), R = new m(), T = new m(), 
    /// @ts-ignore
    W = [], 
    /// @ts-ignore
    _ = [], 
    /// @ts-ignore
    x = (e) => T.get(e) || O.call(f, e), { parse: D } = h({
        /// @ts-ignore
        query: _,
        /// @ts-ignore
        handle: (t, r, n) => {
            ...
            return (s &&
                e(l).then(() => {
                    ...
                    for (let e = 0, { length: t } = s; e < t; e++)
                        o.hasAttribute(s[e]) && n({ target: o, attributeName: s[e], oldValue: null });
                }),
                o);
        };
    })(I, b);
    ...
    $(self)
        ...
        (f.upgrade = function (e) {
            ...
            if (t) {
                const r = T.get(t);
                if (r)
                    return void z(P(e, r.prototype), t);
            }
            q.call(f, e);
        }),
...
//# sourceMappingURL=safari-polyfill.js.map