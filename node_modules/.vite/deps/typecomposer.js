...
// node_modules/typecomposer/dist/esm/global/safari-polyfill.js
if (/^((?!chrome|android).)*safari/i.test(navigator.userAgent)) {
  let G = function(e2) {
    const t2 = C.get(e2);
    D(t2.querySelectorAll(this), e2.isConnected);
  };
  G2 = G;
  const { keys: e } = Object, t = true, r = false, n = "querySelectorAll", o = "querySelectorAll", { document: l, Element: s, MutationObserver: a, Set: c, WeakMap: u } = self, i = (e2) => o in e2, { filter: d } = [];
  h = (e2) => {
    const h3 = new u(), f2 = (t2, r2) => {
      let n2;
      if (r2)
        for (let o2, l2 = ((e3) => e3.matches || e3.webkitMatchesSelector || e3.msMatchesSelector)(t2), s2 = 0, { length: a2 } = p2; s2 < a2; s2++)
          l2.call(t2, o2 = p2[s2]) && (h3.has(t2) || h3.set(t2, new c()), n2 = h3.get(t2), n2.has(o2) || (n2.add(o2), e2.handle(t2, r2, o2)));
      else
        h3.has(t2) && (n2 = h3.get(t2), h3.delete(t2), /// @ts-ignore
        n2.forEach((n3) => {
          e2.handle(t2, r2, n3);
        }));
    }, g2 = (e3, t2 = true) => {
      for (let r2 = 0, { length: n2 } = e3; r2 < n2; r2++)
        f2(e3[r2], t2);
    }, { query: p2 } = e2, b2 = e2.root || l, y2 = ((e3, o2 = document, l2 = MutationObserver, s2 = ["*"]) => {
      const a2 = (r2, o3, l3, s3, c3, u3) => {
        for (const i2 of r2)
          (u3 || n in i2) && (c3 ? l3.has(i2) || (l3.add(i2), s3.delete(i2), e3(i2, c3)) : s3.has(i2) || (s3.add(i2), l3.delete(i2), e3(i2, c3)), u3 || a2(i2[n](o3), o3, l3, s3, c3, t));
      }, c2 = new l2((e4) => {
        if (s2.length) {
          const n2 = s2.join(","), o3 = /* @__PURE__ */ new Set(), l3 = /* @__PURE__ */ new Set();
          for (const { addedNodes: s3, removedNodes: c3 } of e4)
            a2(c3, n2, o3, l3, r, r), a2(s3, n2, o3, l3, t, r);
        }
      }), { observe: u2 } = c2;
      return (c2.observe = (e4) => u2.call(c2, e4, { subtree: t, childList: t }))(o2), c2;
    })(f2, b2, a, p2), { attachShadow: w2 } = s.prototype;
    return w2 && (s.prototype.attachShadow = function(e3) {
      const t2 = w2.call(this, e3);
      return y2.observe(t2), t2;
    }), p2.length && g2(b2[o](p2)), {
      /// @ts-ignore
      drop: (e3) => {
        for (let t2 = 0, { length: r2 } = e3; t2 < r2; t2++)
          h3.delete(e3[t2]);
      },
      flush: () => {
        const e3 = y2.takeRecords();
        for (let t2 = 0, { length: r2 } = e3; t2 < r2; t2++)
          g2(d.call(e3[t2].removedNodes, i), false), g2(d.call(e3[t2].addedNodes, i), true);
      },
      observer: y2,
      parse: g2
    };
  };
  const { customElements: f, document: g, Element: p, MutationObserver: b, Object: y, Promise: w, Map: m, Set: S, WeakMap: v, Reflect: A } = self, { createElement: E } = g, { define: M, get: O, upgrade: q } = f, { construct: k } = A || {
    /// @ts-ignore
    construct(e2) {
      return e2.call(this);
    }
  }, { defineProperty: N, getOwnPropertyNames: $, setPrototypeOf: P } = y, C = new v(), j = new S(), V = new m(), L = new m(), R = new m(), T = new m(), W = [], _ = [], x = (e2) => T.get(e2) || O.call(f, e2), { parse: D } = h({
    /// @ts-ignore
    query: _,
    /// @ts-ignore
    handle: (t2, r2, n2) => {
      const o2 = R.get(n2);
      if (r2 && !o2.isPrototypeOf(t2)) {
        const r3 = ((t3) => {
          const r4 = e(t3), n3 = [], o3 = /* @__PURE__ */ new Set(), { length: l3 } = r4;
          for (let e2 = 0; e2 < l3; e2++) {
            n3[e2] = t3[r4[e2]];
            try {
              delete t3[r4[e2]];
            } catch (t4) {
      ...
      const l2 = (r2 ? "" : "dis") + "connectedCallback";
      l2 in o2 && t2[l2]();
    }
  }), { parse: F } = h({
    /// @ts-ignore
    ...
    /// @ts-ignore
    handle(e2, t2) {
      C.has(e2) && (t2 ? j.add(e2) : j.delete(e2), _.length && G.call(_, e2));
    }
  }), { attachShadow: H } = p.prototype;
  H && (p.prototype.attachShadow = function(e2) {
    const t2 = H.call(this, e2);
    return C.set(this, t2), t2;
  });
  const I = (e2) => {
    if (!L.has(e2)) {
      let t2, r2 = new w((e3) => {
    ...
    const r2 = (e3) => {
      for (let t3 = 0, { length: r3 } = e3; t3 < r3; t3++)
        n2(e3[t3]);
    }, n2 = ({ target: e3, attributeName: t3, oldValue: r3 }) => {
      e3.attributeChangedCallback(t3, r3, e3.getAttribute(t3));
    };
    return (o2, l2) => {
      const { observedAttributes: s2 } = o2.constructor;
      return s2 && e2(l2).then(() => {
        new t2(r2).observe(o2, {
          attributes: true,
          attributeOldValue: true,
          attributeFilter: s2
        });
        for (let e3 = 0, { length: t3 } = s2; e3 < t3; e3++)
          o2.hasAttribute(s2[e3]) && n2({ target: o2, attributeName: s2[e3], oldValue: null });
      }), o2;
    };
  })(I, b);
  let B = null;
  $(self).filter((e2) => /^HTML.*Element$/.test(e2)).forEach((e2) => {
    const t2 = self[e2];
    function r2() {
      const { constructor: e3 } = this;
      if (!V.has(e3))
        throw new TypeError("Illegal constructor");
      const { is: r3, tag: n2 } = V.get(e3);
      if (r3) {
        if (B)
          return z(B, r3);
        const t3 = E.call(g, n2);
        return t3.setAttribute("is", r3), z(P(t3, e3.prototype), r3);
      }
      return k.call(this, t2, [], e3);
    }
    P(r2, t2), N(r2.prototype = t2.prototype, "constructor", { value: r2 }), N(self, e2, { value: r2 });
  }), /// @ts-ignore
  g.createElement = function(e2, t2) {
    const r2 = t2 && t2.is;
    if (r2) {
      const t3 = T.get(r2);
      if (t3 && V.get(t3).tag === e2)
        return new t3();
    }
    const n2 = E.call(g, e2);
    return r2 && n2.setAttribute("is", r2), n2;
  }, f.get = x, f.whenDefined = I, f.upgrade = function(e2) {
    const t2 = e2.getAttribute("is");
    if (t2) {
      const r2 = T.get(t2);
      if (r2)
        return void z(P(e2, r2.prototype), t2);
    }
    q.call(f, e2);
  }, f.define = function(e2, t2, r2) {
    if (x(e2))
      throw new Error(`'${e2}' has already been defined as a custom element`);
    let n2;
    const o2 = r2 && r2.extends;
    V.set(t2, o2 ? { is: e2, tag: o2 } : { is: "", tag: e2 }), o2 ? (n2 = `${o2}[is="${e2}"]`, R.set(n2, t2.prototype), T.set(e2, t2), _.push(n2)) : (
      /// @ts-ignore
      (M.apply(f, arguments), W.push(n2 = e2))
    ), I(e2).then(() => {
      o2 ? (
        /// @ts-ignore
        (D(g.querySelectorAll(n2)), j.forEach(G, [n2]))
      ) : (
        /// @ts-ignore
        F(g.querySelectorAll(n2))
      );
    }), L.get(e2)._(t2);
  };
}
...
// node_modules/typecomposer/dist/esm/global/global.js
...
var construcorOriginal = Element.prototype.constructor;
...
Window.prototype.setTheme = function(theme) {
  ...
  html == null ? void 0 : html.setAttribute("data-theme", theme);
  localStorage.setItem("theme", theme);
};

// node_modules/typecomposer/dist/esm/styles/index.js
var setPropertyOriginal = CSSStyleDeclaration.prototype.setProperty;
Object.defineProperty(CSSStyleDeclaration.prototype, "setProperty", {
  value: function(property, value, priority) {
...
// node_modules/typecomposer/dist/esm/core/decorators/RegisterComponent.js
function Register(options) {
  return function(constructor) {
  };
}

// node_modules/typecomposer/dist/esm/core/decorators/StyleLink.js
...
// node_modules/typecomposer/dist/esm/core/ref/RefProxyHandler.js
var RefString = class extends String {
  constructor(valor, refPropertyKey, refTarget = void 0) {
    super(valor);
    __publicField(this, "refPropertyKey");
    __publicField(this, "refTarget");
  ...
  subscriber(target, propertyKey, refPropertyKey = void 0) {
    if (this.refTarget) {
...
function createProxyRef(target, onNotity, onChange) {
  ...
  let _subscribers = [];
  const registry2 = new FinalizationRegistry((target2) => {
    _subscribers = _subscribers.filter((subscriber) => subscriber.target != target2);
  });
  ...
  function setValueToSubscriber(subscriber, prop, value) {
    var _a;
    try {
      const target2 = (_a = subscriber.target) == null ? void 0 : _a.deref();
      if (target2) {
        if (value && value instanceof RefString)
          value = (value == null ? void 0 : value.toString()) || "";
        if (subscriber.refPropertyKey == void 0 || prop == void 0 || prop == subscriber.refPropertyKey)
          target2[subscriber.propertyKey] = value;
      } else
        return false;
    } catch (error) {
      return false;
  ...
  const proxyHandler = {
    ...
    set: function(target2, prop, value, receiver) {
      if (value instanceof RefString)
        value = value == null ? void 0 : value.toString();
      const resul = Reflect.set(target2, prop, value, receiver);
      notify(prop, value);
      onNotity();
      return resul;
    },
    deleteProperty: function(target2, prop) {
      const resul = Reflect.deleteProperty(target2, prop);
      onNotity();
      return resul;
    }
  };
  proxy["subscriber"] = function(target2, propertyKey, refPropertyKey = void 0, writeOnly = false) {
    if (writeOnly) {
    }
    const item = {
      target: new WeakRef(target2),
      propertyKey,
      refPropertyKey
    };
    let value = refPropertyKey == void 0 ? proxy["value"] : proxy[refPropertyKey];
    if (value instanceof RefString)
      value = value.toString();
    if (setValueToSubscriber(item, refPropertyKey, value)) {
      _subscribers.push(item);
      registry2.register(item.target, item);
    }
  };
  proxy["toString"] = function() {
    var _a;
    return ((_a = proxy["value"]) == null ? void 0 : _a.toString()) || "";
  };
  ...
  proxy["refPropertyKey"] = void 0;
  Object.setPrototypeOf(handler, proxyHandler);
  return proxy;
}

// node_modules/typecomposer/dist/esm/core/ref/Ref.js
function ref(target) {
  const _id = Math.random().toString(36).substr(2, 9);
  const registry2 = new FinalizationRegistry((target2) => {
    _subscribers = _subscribers.filter((subscriber2) => subscriber2.target != target2);
    console.log("FinalizationRegistry: ", target2);
  });
  let _subscribers = [];
  const newTarget = {
    value: target,
  ...
  function createProxy(target2) {
    return createProxyRef(target2, notify, onChange);
  }
  function notify() {
    const remove = [];
    _subscribers.forEach((subscriber2) => {
      if (!setValueToSubscriber(subscriber2))
        remove.push(subscriber2);
    });
    _subscribers = _subscribers.filter((subscriber2) => !remove.includes(subscriber2));
  }
  function setValueToSubscriber(subscriber2) {
    var _a, _b;
    let result = true;
    try {
      const target2 = (_a = subscriber2.target) == null ? void 0 : _a.deref();
      if (target2) {
        if (subscriber2.fun) {
          const fun = (_b = subscriber2.fun) == null ? void 0 : _b.deref();
          if (fun)
            fun(newTarget.value);
          else
            result = false;
    ...
    if (!result) {
      console.log("FinalizationRegistry2: ", subscriber2.target);
      registry2.unregister(subscriber2.target);
      _subscribers = _subscribers.filter((item) => item != subscriber2);
    }
    return result;
  }
  function subscriber(target2, propertyKey) {
  }
  function unsubscribe(data2) {
  }
  function onChange(fun, target2) {
    const data2 = new WeakRef(fun);
    const item = {
      target: target2 ? new WeakRef(target2) : data2,
      propertyKey: void 0,
      refPropertyKey: void 0,
      fun: data2
    };
  ...
  function toString() {
    var _a;
    return ((_a = newTarget.value) == null ? void 0 : _a.toString()) || "";
  }
  return proxy;
}

// node_modules/typecomposer/dist/esm/core/ref/RefComponent.js
function RefComponent(optional) {
  return function(target, propertyKey) {
  };
}

// node_modules/typecomposer/dist/esm/core/factory/Factory.js
var Factory = class {
};

// node_modules/typecomposer/dist/esm/core/factory/editor/Editor.js
var editor = null;
var EditorFactory = class {
  constructor() {
    __publicField(this, "root");
    __publicField(this, "pane", document.createElement("div"));
    __publicField(this, "title");
    this.title = document.title;
    this.root = document.body.children.item(0);
...
document.addEventListener("keydown", function(event) {
  if (event.key === "F1") {
    if (editor) {
      ...
      editor = new EditorFactory();
  }
});

// node_modules/typecomposer/dist/esm/core/element/base/Event.js
var _EventComponent = class _EventComponent extends Event {
  constructor(type, options) {
    super(_EventComponent.serialize + type, options);
    __publicField(this, "data", []);
    __publicField(this, "isInit", false);
    __publicField(this, "eventsListener", /* @__PURE__ */ new Map());
  }
  static emitEvent(type, ...data2) {
    const event = _EventComponent.createEventBase(type, ...data2);
    if (event) {
      if (data2.length > 0)
        event.data = data2;
      event.isInit = true;
  ...
  static createEventBase(type, ...data2) {
    if (type === void 0 || type === null || type === "")
      return null;
    let event = _EventComponent.events.get(type);
    if (event)
      return event;
    event = new _EventComponent(type);
    _EventComponent.events.set(type, event);
    event.data = data2;
    event.isInit = data2.length > 0;
    return event;
  }
  static createEvent(type, ...data2) {
    return _EventComponent.createEventBase(type, ...data2) !== null;
  }
  static addEventListener(component, type, listener, options) {
    const e = _EventComponent.createEventBase(type);
    if (e) {
  ...
  static removeEventListener(component, type) {
    const e = _EventComponent.events.get(type);
    if (e) {
      const listeners = e.eventsListener.get(component);
      if (listeners) {
  ...
  static removeEventListeners(component) {
    for (let type of _EventComponent.events.keys()) {
      _EventComponent.removeEventListener(component, type);
    }
  }
  static deleteEvent(type) {
    ...
    if (e) {
      for (let component of e.eventsListener.keys()) {
        _EventComponent.removeEventListeners(component);
      }
      _EventComponent.events.delete(type);
    }
  }
};
__publicField(_EventComponent, "events", /* @__PURE__ */ new Map());
__publicField(_EventComponent, "serialize", "event-component-");
var EventComponent = _EventComponent;

// node_modules/typecomposer/dist/esm/core/element/base/Elements.js
var Component = class extends HTMLElement {
  ...
  static applyData(data2, element) {
    if (data2 != void 0) {
      if (data2.className != void 0) {
        element.addClasName(data2.className);
      }
      this.applyStyleOrAttribute(data2, element);
    }
  }
  static applyStyleOrAttribute(data2, element) {
    if (data2) {
      Object.keys(data2).forEach((key) => {
        if (data2[key] == void 0)
          return;
        if (key == "for" && data2[key] != void 0)
          element.setAttribute("for", data2[key]);
        else if (key == "className" && data2[key] != void 0)
          element.addClasName(data2[key]);
        else if (key == "text" && data2[key] != void 0)
          element.innerHTML = data2[key];
        else if (element.style.hasOwnProperty(key))
          element.style[key] = data2[key];
        else if (data2[key] != void 0) {
          try {
            element[key] = data2[key];
          } catch (__) {
          }
        }
      });
  ...
  static setVariant(element, variant) {
    const vart = variant == void 0 ? "default-border" : `${variant}-border`;
  ...
  createEvent(type, ...data2) {
    return EventComponent.createEvent(type, ...data2);
  }
  removeEvent(type) {
...
var DivElement = class extends HTMLDivElement {
  constructor(optional) {
    super();
...
var ParagraphElement = class extends HTMLParagraphElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var AnchorElement = class extends HTMLAnchorElement {
  constructor(optional) {
    super();
    __publicField(this, "_rlink", "");
    Component.applyData(optional, this);
...
var AbbreviationElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var AreaElement = class extends HTMLAreaElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var ImageElement = class extends HTMLImageElement {
  constructor(optional) {
    super();
    this.className = "image-element";
    Component.applyData(optional, this);
    if ((optional == null ? void 0 : optional.src) != void 0)
      this.src = optional.src;
  }
};
customElements.define("base-img-element", ImageElement, { extends: "img" });
var UListElement = class extends HTMLUListElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var OrderedListElement = class extends HTMLOListElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var ListItemElement = class extends HTMLLIElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var SpanElement = class extends HTMLSpanElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var StrongElement = class extends HTMLSpanElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var EmElement = class extends HTMLEmbedElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var BreakElement = class extends HTMLBRElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var TableHeadElement = class extends HTMLTableSectionElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var TableBodyElement = class extends HTMLTableSectionElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var TableHeadCellElement = class extends HTMLTableCellElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.colspan)
      this.colSpan = optional.colspan;
    if (optional == null ? void 0 : optional.rowspan)
      this.rowSpan = optional.rowspan;
    if (optional == null ? void 0 : optional.child)
      this.appendChild(optional.child);
    optional == null ? true : delete optional.child;
    Component.applyData(optional, this);
  }
};
customElements.define("base-th-cell-element", TableHeadCellElement, { extends: "th" });
var TableFootElement = class extends HTMLTableSectionElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var TableElement = class extends HTMLTableElement {
  constructor(optional) {
    super();
    __publicField(this, "_head");
    __publicField(this, "_body");
    __publicField(this, "_foot");
    Component.applyData(optional, this);
  }
  addHeadRows(...rows) {
...
var TableFootRowElement = class extends HTMLTableRowElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.cells) {
      this.addCells(...optional.cells);
    }
    optional == null ? true : delete optional.cells;
    Component.applyData(optional, this);
  }
  addCells(...cells) {
    cells.forEach((cell) => {
...
var TableHeadRowElement = class extends HTMLTableRowElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.cells) {
      this.addCells(...optional.cells);
...
var TableRowElement = class extends HTMLTableRowElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.cells) {
      this.addCells(...optional.cells);
...
var TableCellElement = class extends HTMLTableCellElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.colspan)
      this.colSpan = optional.colspan;
...
var PreElement = class extends HTMLPreElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var InputElement = class extends HTMLInputElement {
  constructor(optional) {
    super();
    const v = optional == null ? void 0 : optional.value;
    optional == null ? true : delete optional.value;
    Component.applyData(optional, this);
    if (v) {
      if (typeof v == "string")
        this.value = v;
        ...
        const ref2 = v;
        ref2.subscriber(this, "value", ref2["refPropertyKey"]);
        this.addEventListener("input", (event) => {
          ref2.setValue(this.value, ref2["refPropertyKey"]);
        });
      }
    }
  }
...
var ButtonElement = class extends HTMLButtonElement {
  constructor(optional) {
    super();
    const type = optional == null ? void 0 : optional.type;
    optional == null ? true : delete optional.type;
    Component.applyData(optional, this);
    if (type)
      this.type = type;
    if (optional == null ? void 0 : optional.accept)
      this.accept = optional.accept;
    if (optional == null ? void 0 : optional.multiple)
...
var LabelElement = class extends HTMLLabelElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var SelectElement = class extends HTMLSelectElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var AudioElement = class extends HTMLAudioElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var BoldElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var BodyElement = class extends HTMLBodyElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var VideoElement = class extends HTMLVideoElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var CanvasElement = class extends HTMLCanvasElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.width)
      this.width = optional.width;
    if (optional == null ? void 0 : optional.height)
...
var CaptionElement = class extends HTMLTableCaptionElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var CiteElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var CodeElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional.contentEditable != void 0)
      this.contentEditable = optional.contentEditable.toString();
  }
};
customElements.define("base-code-element", CodeElement, { extends: "code" });
var TableColElement = class extends HTMLTableColElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.span)
      this.span = optional.span;
    Component.applyData(optional, this);
  }
};
customElements.define("base-col-element", TableColElement, { extends: "col" });
var TableColGroupElement = class extends HTMLTableColElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.span)
      this.span = optional.span;
...
var DataListElement = class extends HTMLDataListElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var DefinitionDescriptionElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var DeletedTextElement = class extends HTMLModElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.cite)
...
var DetailsElement = class extends HTMLDetailsElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.open)
      this.open = optional.open;
    if (optional == null ? void 0 : optional.summary) {
  ...
  setSummary(summary) {
    var _a;
    (_a = this.querySelector("summary")) == null ? void 0 : _a.remove();
...
var DefinitionElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var DialogElement = class extends HTMLDialogElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    this.open = optional.open == void 0 ? true : optional.open;
  }
};
customElements.define("base-dialog-element", DialogElement, {
  extends: "dialog"
});
var EmbedElement = class extends HTMLEmbedElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.height)
      this.height = optional.height;
    if (optional == null ? void 0 : optional.src)
      this.src = optional.src;
    if (optional == null ? void 0 : optional.type)
...
var FieldSetElement = class extends HTMLFieldSetElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.disabled)
      this.disabled = optional.disabled;
    if (optional == null ? void 0 : optional.name)
      this.name = optional.name;
    if (optional == null ? void 0 : optional.legend) {
  ...
  setLegend(legend) {
    var _a;
    (_a = this.querySelector("legend")) == null ? void 0 : _a.remove();
...
var FooterElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var FormElement = class extends HTMLFormElement {
  constructor(optional) {
    super();
...
var H1Element = class extends HTMLHeadingElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.text)
      this.innerText = optional.text.toString();
  }
};
customElements.define("base-h1-element", H1Element, { extends: "h1" });
var H2Element = class extends HTMLHeadingElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.text)
...
var H3Element = class extends HTMLHeadingElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.text)
...
var H4Element = class extends H3Element {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.text)
  ...
  addClasName(...names2) {
    this.classList.add(...names2);
  }
};
customElements.define("base-h4-element", H4Element, { extends: "h4" });
var H5Element = class extends H3Element {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.text)
...
var H6Element = class extends H3Element {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.text)
...
var HeadElement = class extends HTMLHeadElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var HeaderElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var HorizontalRuleElement = class extends HTMLHRElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var HtmlElement = class extends HTMLHtmlElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.manifest)
...
var IFrameElement = class extends HTMLIFrameElement {
  constructor(optional) {
    super();
    if (optional == null ? void 0 : optional.allow)
      this.allow = optional.allow;
    if (optional == null ? void 0 : optional.allowfullscreen)
      this.allowfullscreen = optional.allowfullscreen;
    if (optional == null ? void 0 : optional.allowpaymentrequest)
      this.allowpaymentrequest = optional.allowpaymentrequest;
    if (optional == null ? void 0 : optional.csp)
      this.csp = optional.csp;
    if (optional == null ? void 0 : optional.height)
      this.height = optional.height;
    if (optional == null ? void 0 : optional.importance)
      this.importance = optional.importance;
    if (optional == null ? void 0 : optional.loading)
      this.loading = optional.loading;
    if (optional == null ? void 0 : optional.name)
      this.name = optional.name;
    if (optional == null ? void 0 : optional.referrerpolicy)
      this.referrerpolicy = optional.referrerpolicy;
    if (optional == null ? void 0 : optional.src)
      this.src = optional.src;
    if (optional == null ? void 0 : optional.srcdoc)
...
var LegendElement = class extends HTMLLegendElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.value)
...
var SvgElement = class extends HTMLObjectElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
    if (optional == null ? void 0 : optional.width)
  ...
  set color(value) {
    var _a;
    const pathElement = (_a = this.contentDocument) == null ? void 0 : _a.querySelector("path");
    if (pathElement)
      pathElement.style.fill = value;
    else {
      this.onload = () => {
        var _a2;
        const pathElement2 = (_a2 = this.contentDocument) == null ? void 0 : _a2.querySelector("path");
        if (pathElement2)
          pathElement2.style.fill = value;
      };
...
var NavElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var SectionElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var ArticleElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var SummaryElement = class extends HTMLElement {
  constructor(optional) {
    super();
    Component.applyData(optional, this);
  }
...
var ILayout = class extends Component {
  constructor(optional) {
    super(optional);
  }
};
...
// node_modules/typecomposer/dist/esm/core/element/text/TextFieldElement.js
var TextFieldElement = class extends Component {
  constructor(optional) {
    super();
    __publicField(this, "_input");
    __publicField(this, "_label");
    __publicField(this, "_icon");
    __publicField(this, "iconPane", new DivElement({ className: "icon" }));
    this._input = new InputElement({
      type: (optional == null ? void 0 : optional.type) || "text",
      height: "auto",
      width: "100%",
      placeholder: " ",
      value: (optional == null ? void 0 : optional.value) || (optional == null ? void 0 : optional.text) || ""
    });
    this.appendChild(this.input);
    if ((optional == null ? void 0 : optional.placeholderAnimation) == true || (optional == null ? void 0 : optional.placeholderAnimation) == void 0) {
      this._label = new LabelElement({ text: (optional == null ? void 0 : optional.placeholder) || " " });
      this._label.addEventListener("click", () => this.input.focus());
      this.appendChild(this.label);
    } else
      this.input.placeholder = (optional == null ? void 0 : optional.placeholder) || " ";
    this.appendChild(this.iconPane);
    this.iconPane.addEventListener("click", () => this.input.focus());
    Component.setVariant(this.input, optional == null ? void 0 : optional.variant);
    if ((optional == null ? void 0 : optional.icon) != void 0)
      this.icon = optional.icon;
    optional == null ? true : delete optional.value;
    optional == null ? true : delete optional.text;
    Component.applyData(optional, this);
  }
  get input() {
    return this._input;
...
// node_modules/typecomposer/dist/esm/core/element/layers/CardElement.js
var CardElement = class extends Component {
  constructor(optional) {
    super();
...
// node_modules/typecomposer/dist/esm/core/element/layers/VBoxElement.js
var VBoxElement = class extends ILayout {
  constructor(optional) {
    super(optional);
...
// node_modules/typecomposer/dist/esm/core/element/layers/HBoxElement.js
var HBoxElement = class extends ILayout {
  constructor(optional) {
    super(optional);
...
// node_modules/typecomposer/dist/esm/core/element/layers/GridElement.js
var GridElement = class extends ILayout {
  constructor(optional) {
    super(optional);
    this.addClasName("grid-element");
    if (optional == null ? void 0 : optional.columns)
      this.columns = optional.columns;
    if (optional == null ? void 0 : optional.rows)
      this.rows = optional.rows;
    this.columns = "1";
  }
  ...
  set columns(value) {
    if (typeof value == "string")
      ...
      this.style.gridTemplateColumns = `repeat(${value}, auto)`;
  }
  ...
  set rows(value) {
    if (typeof value == "string")
      ...
      this.style.gridTemplateRows = `repeat(${value}, auto)`;
  }
};
customElements.define("grid-element", GridElement);

// node_modules/typecomposer/dist/esm/core/element/layers/BorderPaneElement.js
var BorderPaneElement = class extends ILayout {
  constructor(optional) {
    super(optional);
    __publicField(this, "_top", new DivElement());
    __publicField(this, "_left", new DivElement());
    __publicField(this, "_center", new GridElement());
    __publicField(this, "_centerPane", new DivElement());
    __publicField(this, "_right", new DivElement());
    __publicField(this, "_bottom", new DivElement());
    __publicField(this, "_variant");
    this.variant = (optional == null ? void 0 : optional.variant) || "primary";
  ...
  set top(component) {
    var _a;
    (_a = this._top) == null ? void 0 : _a.remove();
    this._top = component;
  ...
  set left(component) {
    var _a;
    (_a = this._left) == null ? void 0 : _a.remove();
  ...
  set center(component) {
    var _a;
    (_a = this._centerPane) == null ? void 0 : _a.remove();
  ...
  set right(component) {
    var _a;
    (_a = this._right) == null ? void 0 : _a.remove();
  ...
  set bottom(component) {
    var _a;
    (_a = this._bottom) == null ? void 0 : _a.remove();
...
// node_modules/typecomposer/dist/esm/core/element/base/App.js
var _App = class _App {
  constructor() {
  }
  static getTheme() {
  ...
  static getLanguage() {
    return _App.data.language;
  }
  static setTheme(theme) {
    _App.data.theme = theme;
    const html = document.querySelector("html");
    html == null ? void 0 : html.setAttribute("data-theme", theme);
  }
  static setLanguage(language) {
    _App.data.language = language;
  }
  static setPage(page) {
...
__publicField(_App, "data", {
  theme: "light",
  language: "en"
});
var App = _App;

// node_modules/typecomposer/dist/esm/core/element/layers/FlowPane.js
var FlowPane = class extends ILayout {
  constructor(optional) {
...
// node_modules/typecomposer/dist/esm/core/element/action/ListElement.js
var ListElement = class extends Component {
  constructor(optional) {
    super({ height: "100vh", ...optional });
    __publicField(this, "itemSelected", null);
    __publicField(this, "_container", new UListElement());
    __publicField(this, "onSelectItem", () => {
    });
    __publicField(this, "onUnselectItem", () => {
    });
  ...
  appendChild(node) {
    if (node instanceof HTMLCollection) {
      for (let i = 0; i < node.length; i++) {
        ...
        if (item != void 0 && item instanceof HTMLElement)
          this.addItem(item);
      }
  ...
  addItemEventListener(parent, child) {
    parent.addEventListener("click", () => {
      ...
      if (((_a = this.itemSelected) == null ? void 0 : _a.parent) != parent) {
...
// node_modules/typecomposer/dist/esm/core/element/action/TabPane.js
var TabPane = class extends BorderPaneElement {
  constructor(optional) {
    super(optional);
    __publicField(this, "tabs", new DivElement());
    __publicField(this, "slectTabItem", null);
    __publicField(this, "type", "min");
    __publicField(this, "_closeable", false);
    __publicField(this, "onSelectTab", () => {
    });
    ...
    if (optional != void 0 && (optional == null ? void 0 : optional.type) != void 0)
      this.type = optional.type;
    if (optional != void 0 && (optional == null ? void 0 : optional.closeable) != void 0)
      this._closeable = optional.closeable;
    if (optional != void 0 && (optional == null ? void 0 : optional.alignTab) != void 0)
  ...
  set closeable(value) {
    ...
    for (let i = 0; i < ((_a = this.tabs) == null ? void 0 : _a.children.length); i++) {
      const child = this.tabs.children.item(i);
  ...
  getTab(index2) {
    return this.tabs.children.item(index2);
  }
  get select() {
...
// node_modules/typecomposer/dist/esm/core/element/image/IconElement.js
var IconElement = class extends Component {
  constructor(optional) {
    super(optional);
    __publicField(this, "_icon", ref(""));
    if (optional != void 0 && optional.icon != void 0)
      this.icon = optional.icon;
  }
  get icon() {
...
// node_modules/typecomposer/dist/esm/core/element/action/TabItem.js
var TabItem = class extends Component {
  constructor(title, content, icon, closeable = true) {
    super();
    __publicField(this, "title");
    __publicField(this, "__closeable", false);
    __publicField(this, "titleElement");
    __publicField(this, "displayContent");
  ...
  set closeable(value) {
    ...
    if (value && !this.closeIcon) {
      ...
      (_a = this.closeIcon) == null ? void 0 : _a.remove();
      this.closeIcon = null;
    }
  }
  select() {
...
// node_modules/typecomposer/dist/esm/core/element/layers/PaneElement.js
var PaneElement = class extends ILayout {
  constructor(optional) {
    super();
    __publicField(this, "___element_pane__");
...
// node_modules/typecomposer/dist/esm/core/element/action/SlidePane.js
var SlidePane = class extends Component {
};
customElements.define("slide-pane", SlidePane);

// node_modules/typecomposer/dist/esm/core/element/action/DropDown.js
var DropDownItem = class extends DivElement {
};
...
var DropDown = class extends Component {
  constructor(props) {
    ...
    __publicField(this, "onSelectionAction", this.closeAndClean.bind(this));
    __publicField(this, "_selectionType");
    __publicField(this, "previousSelected", []);
    __publicField(this, "_input");
    __publicField(this, "_inputAndButtonDiv");
    __publicField(this, "_options", []);
    __publicField(this, "_dropdownContent");
    __publicField(this, "_idClass");
    __publicField(this, "onChange", () => {
    });
    __publicField(this, "_selected");
    __publicField(this, "textValue");
    __publicField(this, "textSelected");
    this.props = props;
    ...
    if (props.textSelected == void 0 && props.textValue != void 0)
      this.textSelected = props.textValue;
    this.options = props.options == void 0 || props.options.length === 0 ? [props.noContent] : props.options;
  }
  onInit() {
    ...
    this.options.forEach((option, index2) => {
      ...
      if (option instanceof Node)
        ...
        const div = new DropDownItem({
          text: this.textValue ? this.textValue(option) : (option == null ? void 0 : option.toString()) || ""
        });
        node = div;
      ...
      node.onclick = () => {
        ...
        this.input.value = this.textSelected ? this.textSelected(option) : (option == null ? void 0 : option.toString()) || "";
        this._selected = option;
        this.input.style.color = "black";
        this.onChange(option, index2);
        this.dispatchEvent(new CustomEvent("change", { detail: { item: option, index: index2 } }));
      };
    });
  }
...
// node_modules/typecomposer/dist/esm/core/element/action/ChartPane.js
var ChartElement = class _ChartElement extends Component {
  constructor(optional) {
    super(optional);
    __publicField(this, "_canvas", new CanvasElement());
    __publicField(this, "_chart");
    __publicField(this, "ctx");
    this.ctx = this._canvas.getContext("2d");
    this._chart = new Chart(this.ctx, _ChartElement.ChartOptionsEmpty({
      type: optional == null ? void 0 : optional.type,
      data: optional == null ? void 0 : optional.data,
      options: optional == null ? void 0 : optional.options
    }));
  ...
  resize() {
    ...
    (_a = this.chart) == null ? void 0 : _a.resize();
    (_b = this.chart) == null ? void 0 : _b.update();
  ...
  update(config) {
    if (config != void 0) {
      this._chart.data = config.data || _ChartElement.ChartOptionsEmpty().data;
      this._chart.options = config.options || _ChartElement.ChartOptionsEmpty().options;
    }
    if (config.type) {
  ...
  static ChartOptionsEmpty(data2) {
    const result = {
      type: "line",
      data: {
        labels: [],
    ...
    if ((data2 == null ? void 0 : data2.data) != void 0)
      result.data = data2.data;
    if ((data2 == null ? void 0 : data2.options) != void 0)
      result.options = data2.options;
    if ((data2 == null ? void 0 : data2.type) != void 0)
      result.type = data2.type;
    return result;
  }
...
// node_modules/typecomposer/dist/esm/core/element/action/CheckBox.js
var _CheckBox = class _CheckBox extends Component {
  constructor(optional) {
    const label = optional == null ? void 0 : optional.label;
    optional == null ? true : delete optional.label;
    super(optional);
    __publicField(this, "_input");
    __publicField(this, "_label");
    __publicField(this, "_variant", "checkbox");
    __publicField(this, "onChange", () => {
    });
    this._variant = (optional == null ? void 0 : optional.variant) || "checkbox";
    this._input = new InputElement({
      type: this.variant,
      className: this.variant,
      id: `checkbox-${_CheckBox.serial++}-${Math.round(Math.random() * 100)}`
    });
    this.input.value = (optional == null ? void 0 : optional.value) || label || "";
    this._label = new LabelElement({ text: label });
    this._label.setAttribute("for", this._input.id);
    if (optional == null ? void 0 : optional.color)
...
__publicField(_CheckBox, "serial", Math.round(Math.random() * 1e3));
...
// node_modules/typecomposer/dist/esm/core/element/action/ToggleButton.js
var ToggleButton = class extends CheckBox {
  constructor(optional) {
    super({ ...data, color: (optional == null ? void 0 : optional.color) || void 0 });
    ...
    this.addEventListener("change", (e) => {
      if (this.input.checked) {
        ...
        this.label.style.backgroundColor = labelColor;
    });
  }
};
customElements.define("toggle-button", ToggleButton);

// node_modules/typecomposer/dist/esm/core/element/layers/StackPane.js
var StackPane = class extends ILayout {
  constructor(optional) {
    super(optional);
...
// node_modules/typecomposer/dist/esm/core/element/action/SelectField.js
var SelectField = class extends DropDown {
  constructor(optional) {
...
// node_modules/typecomposer/dist/esm/core/element/action/AlertPane.js
var _AlertPane = class _AlertPane extends Component {
  constructor(options) {
    super({
      className: "alert",
      display: "flex",
    ...
    this.append(new SpanElement({ text: (options == null ? void 0 : options.title) || "", className: "fas fa-exclamation-circle " + (options == null ? void 0 : options.type) }));
    this.append(new SpanElement({ text: (options == null ? void 0 : options.message) || "", className: "msg " + (options == null ? void 0 : options.type) }));
    ...
    if (!divAlert)
      document.body.appendChild(_AlertPane._div);
  ...
  static success(title, message, options) {
    return _AlertPane._div.appendChild(new _AlertPane({ ...options, type: "success", message, title }));
  }
  static info(title, message, options) {
    return _AlertPane._div.appendChild(new _AlertPane({ ...options, type: "info", message, title }));
  }
  static warning(title, message, options) {
    return _AlertPane._div.appendChild(new _AlertPane({ ...options, type: "warning", message, title }));
  }
  static danger(title, message, options) {
    return _AlertPane._div.appendChild(new _AlertPane({ ...options, type: "danger", message, title }));
  }
};
__publicField(_AlertPane, "_div", new DivElement({ id: "alert-system" }));
var AlertPane = _AlertPane;
customElements.define("alert-pane", AlertPane);

// node_modules/typecomposer/dist/esm/core/element/action/ColorPicker.js
var ColorPicker = class extends Component {
  constructor(optional) {
    super();
    __publicField(this, "_input", new InputElement({
      type: "color",
      width: "100%",
      height: "100%",
      border: "none",
...
// node_modules/typecomposer/dist/esm/core/components/containment/DialogPane.js
var DialogPane = class extends Component {
  constructor(optional) {
    super(optional);
    __publicField(this, "_content", new CardElement({
      className: "content",
      width: "500px",
      height: "300px"
    }));
    if ((optional == null ? void 0 : optional.display) == void 0)
      this.style.display = "none";
...
// node_modules/typecomposer/dist/esm/core/components/containment/DividerElement.js
var DividerElement = class extends Component {
  constructor(optional) {
    super(optional);
  }
};
...
// node_modules/typecomposer/dist/esm/core/components/containment/ScrollElement.js
var ScrollElement = class extends Component {
  constructor(optional) {
    super(optional);
    if ((optional == null ? void 0 : optional.horizontal) != void 0)
      this.setScrollHorizontal(optional.horizontal);
    if ((optional == null ? void 0 : optional.vertical) != void 0)
      this.setScrolVertical(optional.vertical);
  }
  setScrollHorizontal(horizontal) {
    if (typeof horizontal == "string")
      this.style.overflowX = horizontal;
    else if (horizontal)
      this.style.overflowX = "auto";
    else
      this.style.overflowX = "hidden";
  }
  setScrolVertical(vertical) {
    if (typeof vertical == "string")
      this.style.overflowY = vertical;
    else if (vertical)
...
// node_modules/typecomposer/dist/esm/core/components/navigation/MenuBarElement.js
var MenuBarElement = class extends Component {
  constructor(optional) {
    super();
    __publicField(this, "_nav");
    __publicField(this, "_ul", new UListElement());
    __publicField(this, "checkbox", new InputElement({
      type: "checkbox",
      id: "check"
    }));
    __publicField(this, "checkboxLabel", new LabelElement({
      for: "check",
      className: "checkbtn",
      text: '<i class="fas fa-bars"></i>'
    }));
    __publicField(this, "_logo");
    if (optional == null ? void 0 : optional.logo) {
...
// node_modules/typecomposer/dist/esm/core/router/RouteView.js
var RouteView = class extends Component {
  constructor(optional) {
    super(optional);
    __publicField(this, "_view");
    __publicField(this, "_url", "");
    __publicField(this, "routePage");
  }
  get url() {
    return this._url;
  }
  ...
  disconnectedCallback() {
    if (this.routePage)
      this.routePage.routeView = void 0;
    this.routePage = void 0;
  }
  get view() {
    return this._view;
  }
  set view(value) {
    ...
    this._view = value;
    if (value)
      this == null ? void 0 : this.append(value);
  }
};
customElements.define("route-view", RouteView);

// node_modules/typecomposer/dist/esm/core/router/Router.js
var _RouterController = class _RouterController {
  constructor() {
    __publicField(this, "_route");
    __publicField(this, "routePages", []);
    __publicField(this, "currentRoute", []);
    __publicField(this, "previousRoute", []);
    __publicField(this, "urlLast", "");
  ...
  findCorrectRoute(pathname, routes = ((_a) => (_a = this.route) == null ? void 0 : _a.routes)() || []) {
    if (routes) {
      for (const route of routes) {
        if (this.doRoutesMatch(pathname, route.path)) {
          this.currentRoute.push({
            ...
            build: void 0,
            routeView: void 0,
            parent: this.currentRoute.length > 0 ? this.currentRoute[this.currentRoute.length - 1] : void 0
          });
          return route.path;
        }
      }
  ...
  async buildRoute(routes = ((_b) => (_b = this.route) == null ? void 0 : _b.routes)(), parent = "") {
    if (routes) {
  ...
  async buildPages() {
    let routePageBuildLast = void 0;
    for (let i = 0; i < this.currentRoute.length; i++) {
      if (i + 1 < this.currentRoute.length && this.previousRoute[i] != void 0 && this.currentRoute[i].id == this.previousRoute[i].id) {
    ...
    if (toBuild.build == void 0) {
      toBuild.build = new toBuild.component();
      this.setView(toBuild.build);
    }
    if (routePageBuildLast == null ? void 0 : routePageBuildLast.routeView) {
  ...
  get props() {
    return _RouterController._props;
  }
  set props(value) {
    _RouterController._props = value;
  }
  addHistory(pathname) {
  ...
  getRouteViewFree(routeView) {
    let index2 = Array.from(document.querySelectorAll("route-view") || []).findIndex((r) => r == routeView);
    if (index2 == -1 || index2 >= this.currentRoute.length)
      return void 0;
    this.currentRoute[index2++].routeView = routeView;
    return this.currentRoute.length > index2 ? this.currentRoute[index2] : void 0;
  }
  getView(routeView) {
    if (routeView) {
      if (routeView.build == void 0) {
  ...
  pageNotFound() {
    var _a;
    if ((_a = this.route) == null ? void 0 : _a.pageNotFound)
      ...
      body.innerHTML = "<div style='text-align: center;'><h1 style='text-shadow: 0 3px 0px $color-base, 0 6px 0px #333; color: #f54f59; font-size: 6em; font-weight: 700; line-height: 0.6em;'>404</h1><h1 style='text-shadow: 0 3px 0px $color-base, 0 6px 0px #333; color: #f54f59; font-size: 10; font-weight: 15; line-height: 0.6em;'>Page not found</h1></div>";
      document.body = body;
    }
  }
  setView(view) {
    ...
    if (!(document.body.lastElementChild instanceof HTMLScriptElement))
      (_b = (_a = document.body) == null ? void 0 : _a.lastElementChild) == null ? void 0 : _b.remove();
...
__publicField(_RouterController, "_props", {});
var RouterController = _RouterController;
var _Router = class _Router {
  constructor(routes = [], history = "history", pageNotFound = void 0) {
    __publicField(this, "routes");
    __publicField(this, "history");
    __publicField(this, "pageNotFound");
    this.routes = routes;
    this.history = history;
    this.pageNotFound = pageNotFound;
    _Router.createAutoId(this.routes, 0);
  }
  beforeEach(callback2) {
  }
  static get props() {
    return _Router._props;
  }
  static create(data2) {
    if (_Router.controller.route)
      throw new Error("Router already exists");
    _Router.controller.route = new _Router(data2.routes, data2.history, data2.pageNotFound);
  }
  static buildURL(baseUrl, parametros) {
    const queryString = Object.keys(parametros).map((key) => encodeURIComponent(key) + "=" + encodeURIComponent(parametros[key])).join("&");
  ...
  static async go(pathname, props = {}) {
    pathname = _Router.buildURL(pathname, props);
    this.controller.addHistory(pathname);
  }
};
__publicField(_Router, "controller", new RouterController());
__publicField(_Router, "_props", {});
var Router = _Router;
export {
  AbbreviationElement,
  AlertPane,
...
chart.js/dist/chart.js:
   ...
   *)
*/
//# sourceMappingURL=typecomposer.js.map
